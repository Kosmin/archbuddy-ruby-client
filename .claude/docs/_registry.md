...
Deeper topics that don't belong in the root pyramid. Last updated: 2026-07-20.
...
| [cross-repo.md](cross-repo.md) | The two-repo system: this client ↔ the `architecture_auditor` engine; the shared Contract; what crosses the boundary and what must not; the version/changelog block (client 0.11.0 / engine 0.9.0 — graph 1.4 probe-gated `outcome_arity`/`escapes`, findings 1.7 `variety_mass` read nil-tolerantly, SERIALIZER v4 client-owned) | 2026-07-20 |
